...
//! # Data flow
//!
//! The list of objects to display in this panel is generated by the [`generate_object_list`] system,
//! which stores the generated list in the [`InspectorCache`] resource. The [`sync_object_list`] system then reads from this cache
